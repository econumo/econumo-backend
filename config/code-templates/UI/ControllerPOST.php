...
class Controller extends AbstractController
{
     ...
     *     in="body",
     *     required=true,
     *     @SWG\Schema(ref=@SwgModel(type=\App\UI\Controller\__CG_URL_TYPE_CC__\__CG_API_VERSION_CC__\__CG_API_SUBJECT_CC__\__CG_API_ACTION_CC__\Model::class)),
     * ),
     * @SWG\Response(
     *     response=200,
     *     description="OK",
    ...
    {
        $model = new Model();
        $this->validator->validate(Form::class, $request->request->all(), $model);
