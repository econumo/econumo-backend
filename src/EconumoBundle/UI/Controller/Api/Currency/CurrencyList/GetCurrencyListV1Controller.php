...
namespace App\EconumoBundle\UI\Controller\Api\Currency\CurrencyList;

use App\EconumoBundle\Application\Currency\CurrencyListService;
use App\EconumoBundle\Application\Currency\Dto\GetCurrencyListV1RequestDto;
use App\EconumoBundle\UI\Controller\Api\Currency\CurrencyList\Validation\GetCurrencyListV1Form;
...
class GetCurrencyListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Currency\Dto\GetCurrencyListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
