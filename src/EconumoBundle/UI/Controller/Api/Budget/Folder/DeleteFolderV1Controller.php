...
use App\EconumoBundle\UI\Controller\Api\Budget\Folder\Validation\DeleteFolderV1Form;
...
class DeleteFolderV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Budget\Dto\DeleteFolderV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
