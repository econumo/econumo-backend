...
use App\EconumoBundle\UI\Controller\Api\Budget\Envelope\Validation\UpdateEnvelopeV1Form;
...
class UpdateEnvelopeV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoBundle\Application\Budget\Dto\UpdateEnvelopeV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Budget\Dto\UpdateEnvelopeV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
