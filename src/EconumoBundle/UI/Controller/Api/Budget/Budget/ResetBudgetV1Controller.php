...
use App\EconumoBundle\UI\Controller\Api\Budget\Budget\Validation\ResetBudgetV1Form;
...
class ResetBudgetV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Budget\Dto\ResetBudgetV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
