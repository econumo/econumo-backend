...
use App\EconumoBundle\UI\Controller\Api\Budget\Budget\Validation\UpdateBudgetV1Form;
...
class UpdateBudgetV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Budget\Dto\UpdateBudgetV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
