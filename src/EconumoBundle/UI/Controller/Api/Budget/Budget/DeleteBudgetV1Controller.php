...
use App\EconumoBundle\UI\Controller\Api\Budget\Budget\Validation\DeleteBudgetV1Form;
...
class DeleteBudgetV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Budget\Dto\DeleteBudgetV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
