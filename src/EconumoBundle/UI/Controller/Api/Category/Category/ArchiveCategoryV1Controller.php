...
use App\EconumoBundle\UI\Controller\Api\Category\Category\Validation\ArchiveCategoryV1Form;
...
class ArchiveCategoryV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Category\Dto\ArchiveCategoryV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
