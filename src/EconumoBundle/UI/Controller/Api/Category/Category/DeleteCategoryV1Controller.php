...
use App\EconumoBundle\UI\Controller\Api\Category\Category\Validation\DeleteCategoryV1Form;
...
class DeleteCategoryV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Category\Dto\DeleteCategoryV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
