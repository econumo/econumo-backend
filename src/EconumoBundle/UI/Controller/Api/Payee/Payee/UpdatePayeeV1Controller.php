...
use App\EconumoBundle\UI\Controller\Api\Payee\Payee\Validation\UpdatePayeeV1Form;
...
class UpdatePayeeV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Payee\Dto\UpdatePayeeV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
