...
use App\EconumoBundle\UI\Controller\Api\Payee\Payee\Validation\DeletePayeeV1Form;
...
class DeletePayeeV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Payee"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoBundle\Application\Payee\Dto\DeletePayeeV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Payee\Dto\DeletePayeeV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
