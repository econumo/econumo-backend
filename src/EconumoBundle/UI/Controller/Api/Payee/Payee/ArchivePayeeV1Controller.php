...
use App\EconumoBundle\UI\Controller\Api\Payee\Payee\Validation\ArchivePayeeV1Form;
...
class ArchivePayeeV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Payee"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoBundle\Application\Payee\Dto\ArchivePayeeV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Payee\Dto\ArchivePayeeV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
