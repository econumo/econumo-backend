...
use App\EconumoBundle\UI\Controller\Api\Payee\PayeeList\Validation\OrderPayeeListV1Form;
...
class OrderPayeeListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Payee\Dto\OrderPayeeListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
