...
namespace App\EconumoBundle\UI\Controller\Api\User\OptionList;

use App\EconumoBundle\Application\User\OptionListService;
use App\EconumoBundle\Application\User\Dto\GetOptionListV1RequestDto;
use App\EconumoBundle\UI\Controller\Api\User\OptionList\Validation\GetOptionListV1Form;
...
class GetOptionListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\User\Dto\GetOptionListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
