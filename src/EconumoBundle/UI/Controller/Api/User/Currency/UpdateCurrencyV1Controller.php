...
namespace App\EconumoBundle\UI\Controller\Api\User\Currency;

use App\EconumoBundle\Application\User\CurrencyService;
use App\EconumoBundle\Application\User\Dto\UpdateCurrencyV1RequestDto;
use App\EconumoBundle\UI\Controller\Api\User\Currency\Validation\UpdateCurrencyV1Form;
...
class UpdateCurrencyV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\User\Dto\UpdateCurrencyV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
