...
use App\EconumoBundle\UI\Controller\Api\User\Password\Validation\ResetPasswordV1Form;
...
class ResetPasswordV1Controller extends AbstractController
{
     ...
     * @OA\Post(
     *      security={},
     *      @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoBundle\Application\User\Dto\ResetPasswordV1RequestDto::class))),
     *      @OA\Response(
     *          response=200,
     *          description="OK",
     *          @OA\JsonContent(
