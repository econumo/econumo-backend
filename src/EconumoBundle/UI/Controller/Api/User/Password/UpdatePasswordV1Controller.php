...
use App\EconumoBundle\UI\Controller\Api\User\Password\Validation\UpdatePasswordV1Form;
...
class UpdatePasswordV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\User\Dto\UpdatePasswordV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
