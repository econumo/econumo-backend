...
use App\EconumoBundle\UI\Controller\Api\User\User\Validation\RegisterUserV1Form;
...
class RegisterUserV1Controller extends AbstractController
{
     ...
     * @OA\Post(
     *     security={},
     *     @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoBundle\Application\User\Dto\RegisterUserV1RequestDto::class))),
     *     @OA\Response(
     *         response=200,
     *         description="OK",
     *         @OA\JsonContent(
     ...
     *                     @OA\Property(
     *                         property="data",
     *                         ref=@Model(type=\App\EconumoBundle\Application\User\Dto\RegisterUserV1ResultDto::class)
     *                     )
     *                 )
     *             }
     *         )
