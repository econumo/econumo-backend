...
use App\EconumoBundle\UI\Controller\Api\Account\Folder\Validation\HideFolderV1Form;
...
class HideFolderV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Account\Dto\HideFolderV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
