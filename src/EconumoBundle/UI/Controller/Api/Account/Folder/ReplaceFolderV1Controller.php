...
use App\EconumoBundle\UI\Controller\Api\Account\Folder\Validation\ReplaceFolderV1Form;
...
class ReplaceFolderV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Account"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoBundle\Application\Account\Dto\ReplaceFolderV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Account\Dto\ReplaceFolderV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
