...
use App\EconumoBundle\UI\Controller\Api\Account\Folder\Validation\ShowFolderV1Form;
...
class ShowFolderV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Account\Dto\ShowFolderV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
