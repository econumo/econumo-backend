...
use App\EconumoBundle\UI\Controller\Api\Account\AccountList\Validation\OrderAccountListV1Form;
...
class OrderAccountListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Account\Dto\OrderAccountListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
