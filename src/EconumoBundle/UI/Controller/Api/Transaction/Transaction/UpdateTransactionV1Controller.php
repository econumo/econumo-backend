...
use App\EconumoBundle\UI\Controller\Api\Transaction\Transaction\Validation\UpdateTransactionV1Form;
...
class UpdateTransactionV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Transaction\Dto\UpdateTransactionV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
