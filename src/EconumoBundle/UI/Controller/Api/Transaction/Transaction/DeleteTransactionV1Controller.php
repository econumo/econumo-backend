...
use App\EconumoBundle\UI\Controller\Api\Transaction\Transaction\Validation\DeleteTransactionV1Form;
...
class DeleteTransactionV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Transaction\Dto\DeleteTransactionV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
