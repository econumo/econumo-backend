...
use App\EconumoBundle\UI\Controller\Api\Tag\Tag\Validation\DeleteTagV1Form;
...
class DeleteTagV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Tag\Dto\DeleteTagV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
