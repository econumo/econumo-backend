...
use App\EconumoBundle\UI\Controller\Api\Tag\TagList\Validation\OrderTagListV1Form;
...
class OrderTagListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoBundle\Application\Tag\Dto\OrderTagListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
