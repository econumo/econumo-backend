...
namespace App\EconumoOneBundle\UI\Middleware\HttpApiResponse;

use App\EconumoOneBundle\Application\Exception\ValidationException;
use App\EconumoOneBundle\Domain\Exception\AccessDeniedException as DomainAccessDeniedException;
