...
namespace App\EconumoOneBundle\UI\Controller\Api\User\Budget;

use App\EconumoOneBundle\Application\User\BudgetService;
use App\EconumoOneBundle\Application\User\Dto\UpdateBudgetV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\User\Budget\Validation\UpdateBudgetV1Form;
...
class UpdateBudgetV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="User"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\User\Dto\UpdateBudgetV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\User\Dto\UpdateBudgetV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
