...
use App\EconumoOneBundle\UI\Controller\Api\User\User\Validation\LogoutUserV1Form;
...
class LogoutUserV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\User\Dto\LogoutUserV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
