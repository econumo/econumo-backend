...
namespace App\EconumoOneBundle\UI\Controller\Api\User\Currency;

use App\EconumoOneBundle\Application\User\CurrencyService;
use App\EconumoOneBundle\Application\User\Dto\UpdateCurrencyV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\User\Currency\Validation\UpdateCurrencyV1Form;
...
{
    public function __construct(private readonly CurrencyService $currencyService, private readonly ValidatorInterface $validator)
    {
    }
     ...
     *
     * @OA\Tag(name="User"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\User\Dto\UpdateCurrencyV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\User\Dto\UpdateCurrencyV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
