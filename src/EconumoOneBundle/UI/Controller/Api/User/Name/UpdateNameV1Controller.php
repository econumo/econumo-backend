...
namespace App\EconumoOneBundle\UI\Controller\Api\User\Name;

use App\EconumoOneBundle\Application\User\NameService;
use App\EconumoOneBundle\Application\User\Dto\UpdateNameV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\User\Name\Validation\UpdateNameV1Form;
...
class UpdateNameV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="User"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\User\Dto\UpdateNameV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\User\Dto\UpdateNameV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
