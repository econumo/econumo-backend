...
use App\EconumoOneBundle\UI\Controller\Api\User\Password\Validation\UpdatePasswordV1Form;
...
class UpdatePasswordV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="User"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\User\Dto\UpdatePasswordV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\User\Dto\UpdatePasswordV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
