...
use App\EconumoOneBundle\UI\Controller\Api\User\Password\Validation\RemindPasswordV1Form;
...
class RemindPasswordV1Controller extends AbstractController
{
     ...
     * @OA\Post(
     *     security={},
     *     @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\User\Dto\RemindPasswordV1RequestDto::class))),
     *     @OA\Response(
     *         response=200,
     *         description="OK",
     *         @OA\JsonContent(
     ...
     *                     @OA\Property(
     *                         property="data",
     *                         ref=@Model(type=\App\EconumoOneBundle\Application\User\Dto\RemindPasswordV1ResultDto::class)
     *                     )
     *                 )
     *             }
     *         )
