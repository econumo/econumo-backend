...
namespace App\EconumoOneBundle\UI\Controller\Api\User\UserData;

use App\EconumoOneBundle\Application\User\UserDataService;
use App\EconumoOneBundle\Application\User\Dto\GetUserDataV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\User\UserData\Validation\GetUserDataV1Form;
...
class GetUserDataV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\User\Dto\GetUserDataV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
