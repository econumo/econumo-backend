...
namespace App\EconumoOneBundle\UI\Controller\Api\User\OptionList;

use App\EconumoOneBundle\Application\User\OptionListService;
use App\EconumoOneBundle\Application\User\Dto\GetOptionListV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\User\OptionList\Validation\GetOptionListV1Form;
...
class GetOptionListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\User\Dto\GetOptionListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
