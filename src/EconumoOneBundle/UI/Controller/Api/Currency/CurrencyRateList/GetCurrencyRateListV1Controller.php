...
namespace App\EconumoOneBundle\UI\Controller\Api\Currency\CurrencyRateList;

use App\EconumoOneBundle\Application\Currency\CurrencyRateListService;
use App\EconumoOneBundle\Application\Currency\Dto\GetCurrencyRateListV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Currency\CurrencyRateList\Validation\GetCurrencyRateListV1Form;
...
class GetCurrencyRateListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Currency\Dto\GetCurrencyRateListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
