...
namespace App\EconumoOneBundle\UI\Controller\Api\Currency\CurrencyList;

use App\EconumoOneBundle\Application\Currency\CurrencyListService;
use App\EconumoOneBundle\Application\Currency\Dto\GetCurrencyListV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Currency\CurrencyList\Validation\GetCurrencyListV1Form;
...
class GetCurrencyListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Currency\Dto\GetCurrencyListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
