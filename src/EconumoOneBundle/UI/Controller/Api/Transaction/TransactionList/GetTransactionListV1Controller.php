...
namespace App\EconumoOneBundle\UI\Controller\Api\Transaction\TransactionList;

use App\EconumoOneBundle\Application\Transaction\TransactionListService;
use App\EconumoOneBundle\Application\Transaction\Dto\GetTransactionListV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Transaction\TransactionList\Validation\GetTransactionListV1Form;
...
class GetTransactionListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Transaction\Dto\GetTransactionListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
