...
use App\EconumoOneBundle\UI\Controller\Api\Transaction\Transaction\Validation\CreateTransactionV1Form;
...
class CreateTransactionV1Controller extends AbstractController
{
     ...
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Transaction\Dto\CreateTransactionV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Transaction\Dto\CreateTransactionV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
