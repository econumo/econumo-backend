...
namespace App\EconumoOneBundle\UI\Controller\Api\Transaction\Transaction;

use App\EconumoOneBundle\Application\Transaction\TransactionService;
use App\EconumoOneBundle\Application\Transaction\Dto\UpdateTransactionV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Transaction\Transaction\Validation\UpdateTransactionV1Form;
...
class UpdateTransactionV1Controller extends AbstractController
{
     ...
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Transaction\Dto\UpdateTransactionV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Transaction\Dto\UpdateTransactionV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
