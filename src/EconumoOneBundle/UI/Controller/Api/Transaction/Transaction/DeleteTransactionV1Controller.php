...
use App\EconumoOneBundle\UI\Controller\Api\Transaction\Transaction\Validation\DeleteTransactionV1Form;
...
class DeleteTransactionV1Controller extends AbstractController
{
     ...
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Transaction\Dto\DeleteTransactionV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Transaction\Dto\DeleteTransactionV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
