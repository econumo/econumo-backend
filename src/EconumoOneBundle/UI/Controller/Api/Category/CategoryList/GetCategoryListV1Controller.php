...
use App\EconumoOneBundle\UI\Controller\Api\Category\CategoryList\Validation\GetCategoryListV1Form;
...
class GetCategoryListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Category\Dto\GetCategoryListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
