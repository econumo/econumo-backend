...
namespace App\EconumoOneBundle\UI\Controller\Api\Category\CategoryList;

use App\EconumoOneBundle\Application\Category\CategoryListService;
use App\EconumoOneBundle\Application\Category\Dto\OrderCategoryListV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Category\CategoryList\Validation\OrderCategoryListV1Form;
...
class OrderCategoryListV1Controller extends AbstractController
{
     ...
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Category\Dto\OrderCategoryListV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Category\Dto\OrderCategoryListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
