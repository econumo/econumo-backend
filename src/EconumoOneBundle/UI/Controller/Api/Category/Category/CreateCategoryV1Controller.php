...
use App\EconumoOneBundle\UI\Controller\Api\Category\Category\Validation\CreateCategoryV1Form;
...
class CreateCategoryV1Controller extends AbstractController
{
     ...
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Category\Dto\CreateCategoryV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Category\Dto\CreateCategoryV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
