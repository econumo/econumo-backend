...
use App\EconumoOneBundle\UI\Controller\Api\Category\Category\Validation\UpdateCategoryV1Form;
...
class UpdateCategoryV1Controller extends AbstractController
{
     ...
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Category\Dto\UpdateCategoryV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Category\Dto\UpdateCategoryV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
