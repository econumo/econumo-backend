...
namespace App\EconumoOneBundle\UI\Controller\Api\Analytics\Balance;

use App\EconumoOneBundle\Application\Analytics\BalanceService;
use App\EconumoOneBundle\Application\Analytics\Dto\GetBalanceV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Analytics\Balance\Validation\GetBalanceV1Form;
...
class GetBalanceV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Analytics\Dto\GetBalanceV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
