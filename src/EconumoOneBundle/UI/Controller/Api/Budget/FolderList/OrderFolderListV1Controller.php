...
namespace App\EconumoOneBundle\UI\Controller\Api\Budget\FolderList;

use App\EconumoOneBundle\Application\Budget\FolderListService;
use App\EconumoOneBundle\Application\Budget\Dto\OrderFolderListV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Budget\FolderList\Validation\OrderFolderListV1Form;
...
class OrderFolderListV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\OrderFolderListV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\OrderFolderListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
