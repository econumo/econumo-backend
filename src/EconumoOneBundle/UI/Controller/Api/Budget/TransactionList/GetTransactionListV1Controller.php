...
namespace App\EconumoOneBundle\UI\Controller\Api\Budget\TransactionList;

use App\EconumoOneBundle\Application\Budget\TransactionListService;
use App\EconumoOneBundle\Application\Budget\Dto\GetTransactionListV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Budget\TransactionList\Validation\GetTransactionListV1Form;
...
class GetTransactionListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\GetTransactionListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
     ...
     */
    #[Route(path: '/api/v1/budget/get-transaction-list', methods: ['GET'])]
