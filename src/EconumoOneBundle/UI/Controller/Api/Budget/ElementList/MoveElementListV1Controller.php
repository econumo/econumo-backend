...
namespace App\EconumoOneBundle\UI\Controller\Api\Budget\ElementList;

use App\EconumoOneBundle\Application\Budget\ElementListService;
use App\EconumoOneBundle\Application\Budget\Dto\MoveElementListV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Budget\ElementList\Validation\MoveElementListV1Form;
...
class MoveElementListV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\MoveElementListV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\MoveElementListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
