...
namespace App\EconumoOneBundle\UI\Controller\Api\Budget\Account;

use App\EconumoOneBundle\Application\Budget\AccountService;
use App\EconumoOneBundle\Application\Budget\Dto\ExcludeAccountV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Budget\Account\Validation\ExcludeAccountV1Form;
...
class ExcludeAccountV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\ExcludeAccountV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\ExcludeAccountV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
     ...
     */
    #[Route(path: '/api/v1/budget/exclude-account', methods: ['POST'])]
