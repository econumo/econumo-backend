...
use App\EconumoOneBundle\UI\Controller\Api\Budget\Envelope\Validation\DeleteEnvelopeV1Form;
...
class DeleteEnvelopeV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\DeleteEnvelopeV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\DeleteEnvelopeV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
