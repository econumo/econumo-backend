...
namespace App\EconumoOneBundle\UI\Controller\Api\Budget\BudgetList;

use App\EconumoOneBundle\Application\Budget\BudgetListService;
use App\EconumoOneBundle\Application\Budget\Dto\GetBudgetListV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Budget\BudgetList\Validation\GetBudgetListV1Form;
...
class GetBudgetListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\GetBudgetListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
