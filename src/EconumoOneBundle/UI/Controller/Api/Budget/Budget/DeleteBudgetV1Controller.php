...
use App\EconumoOneBundle\UI\Controller\Api\Budget\Budget\Validation\DeleteBudgetV1Form;
...
class DeleteBudgetV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\DeleteBudgetV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\DeleteBudgetV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
    ...
    public function __invoke(Request $request): Response
    {
        ...
        $this->validator->validate(DeleteBudgetV1Form::class, $request->request->all(), $dto);
        /** @var User $user */
        $user = $this->getUser();
        $result = $this->budgetService->deleteBudget($dto, $user->getId());
