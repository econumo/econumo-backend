...
use App\EconumoOneBundle\UI\Controller\Api\Budget\Access\Validation\RevokeAccessV1Form;
...
class RevokeAccessV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\RevokeAccessV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\RevokeAccessV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
