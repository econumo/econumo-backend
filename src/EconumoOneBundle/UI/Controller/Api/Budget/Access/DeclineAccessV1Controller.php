...
use App\EconumoOneBundle\Application\Budget\Dto\DeclineAccessV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Budget\Access\Validation\DeclineAccessV1Form;
...
class DeclineAccessV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\DeclineAccessV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Budget\Dto\DeclineAccessV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
     ...
     */
    #[Route(path: '/api/v1/budget/decline-access', methods: ['POST'])]
