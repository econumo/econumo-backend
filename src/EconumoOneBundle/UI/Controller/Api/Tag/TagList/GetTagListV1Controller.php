...
use App\EconumoOneBundle\UI\Controller\Api\Tag\TagList\Validation\GetTagListV1Form;
...
class GetTagListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Tag\Dto\GetTagListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
