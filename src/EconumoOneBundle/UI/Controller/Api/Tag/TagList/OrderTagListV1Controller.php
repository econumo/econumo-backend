...
namespace App\EconumoOneBundle\UI\Controller\Api\Tag\TagList;

use App\EconumoOneBundle\Application\Tag\TagListService;
use App\EconumoOneBundle\Application\Tag\Dto\OrderTagListV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Tag\TagList\Validation\OrderTagListV1Form;
...
class OrderTagListV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Tag"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Tag\Dto\OrderTagListV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Tag\Dto\OrderTagListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
