...
use App\EconumoOneBundle\UI\Controller\Api\Tag\Tag\Validation\ArchiveTagV1Form;
...
class ArchiveTagV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Tag"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Tag\Dto\ArchiveTagV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Tag\Dto\ArchiveTagV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
