...
use App\EconumoOneBundle\UI\Controller\Api\Tag\Tag\Validation\CreateTagV1Form;
...
class CreateTagV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Tag"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Tag\Dto\CreateTagV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Tag\Dto\CreateTagV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
