...
namespace App\EconumoOneBundle\UI\Controller\Api\Tag\Tag;

use App\EconumoOneBundle\Application\Tag\TagService;
use App\EconumoOneBundle\Application\Tag\Dto\UnarchiveTagV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Tag\Tag\Validation\UnarchiveTagV1Form;
...
class UnarchiveTagV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Tag"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Tag\Dto\UnarchiveTagV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Tag\Dto\UnarchiveTagV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
