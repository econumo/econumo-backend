...
use App\EconumoOneBundle\UI\Controller\Api\Account\Account\Validation\CreateAccountV1Form;
...
class CreateAccountV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Account"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Account\Dto\CreateAccountV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Account\Dto\CreateAccountV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
