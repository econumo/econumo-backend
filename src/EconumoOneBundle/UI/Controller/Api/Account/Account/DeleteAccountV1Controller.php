...
namespace App\EconumoOneBundle\UI\Controller\Api\Account\Account;

use App\EconumoOneBundle\Application\Account\AccountService;
use App\EconumoOneBundle\Application\Account\Dto\DeleteAccountV1RequestDto;
use App\EconumoOneBundle\Domain\Entity\User;
use App\EconumoOneBundle\UI\Controller\Api\Account\Account\Validation\DeleteAccountV1Form;
...
class DeleteAccountV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Account"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Account\Dto\DeleteAccountV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Account\Dto\DeleteAccountV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
     ...
     */
    #[Route(path: '/api/v1/account/delete-account', methods: ['POST'])]
