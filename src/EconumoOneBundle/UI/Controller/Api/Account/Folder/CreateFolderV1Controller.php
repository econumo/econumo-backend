...
use App\EconumoOneBundle\UI\Controller\Api\Account\Folder\Validation\CreateFolderV1Form;
...
class CreateFolderV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Account"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Account\Dto\CreateFolderV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Account\Dto\CreateFolderV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
