...
use App\EconumoOneBundle\UI\Controller\Api\Account\Folder\Validation\HideFolderV1Form;
...
class HideFolderV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Account"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Account\Dto\HideFolderV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Account\Dto\HideFolderV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
