...
use App\EconumoOneBundle\UI\Controller\Api\Account\FolderList\Validation\OrderFolderListV1Form;
...
class OrderFolderListV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Account"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Account\Dto\OrderFolderListV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Account\Dto\OrderFolderListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
