...
use App\EconumoOneBundle\UI\Controller\Api\Account\AccountList\Validation\GetAccountListV1Form;
...
class GetAccountListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Account\Dto\GetAccountListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
