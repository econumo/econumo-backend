...
use App\EconumoOneBundle\UI\Controller\Api\Payee\PayeeList\Validation\GetPayeeListV1Form;
...
class GetPayeeListV1Controller extends AbstractController
{
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Payee\Dto\GetPayeeListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
