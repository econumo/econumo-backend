...
use App\EconumoOneBundle\UI\Controller\Api\Payee\Payee\Validation\DeletePayeeV1Form;
...
class DeletePayeeV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Payee"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Payee\Dto\DeletePayeeV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Payee\Dto\DeletePayeeV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
    ...
    public function __invoke(Request $request): Response
    {
        ...
        $this->validator->validate(DeletePayeeV1Form::class, $request->request->all(), $dto);
        /** @var User $user */
        $user = $this->getUser();
        $result = $this->payeeService->deletePayee($dto, $user->getId());
