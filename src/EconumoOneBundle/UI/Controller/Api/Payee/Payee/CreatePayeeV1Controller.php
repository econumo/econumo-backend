...
use App\EconumoOneBundle\UI\Controller\Api\Payee\Payee\Validation\CreatePayeeV1Form;
...
class CreatePayeeV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Payee"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Payee\Dto\CreatePayeeV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Payee\Dto\CreatePayeeV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
