...
namespace App\EconumoOneBundle\UI\Controller\Api\Connection\Connection;

use App\EconumoOneBundle\Application\Connection\ConnectionService;
use App\EconumoOneBundle\Application\Connection\Dto\DeleteConnectionV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Connection\Connection\Validation\DeleteConnectionV1Form;
...
class DeleteConnectionV1Controller extends AbstractController
{
     ...
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Connection\Dto\DeleteConnectionV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Connection\Dto\DeleteConnectionV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
