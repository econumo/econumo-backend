...
use App\EconumoOneBundle\UI\Controller\Api\Connection\AccountAccess\Validation\SetAccountAccessV1Form;
...
class SetAccountAccessV1Controller extends AbstractController
{
     ...
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Connection\Dto\SetAccountAccessV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Connection\Dto\SetAccountAccessV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
     ...
     */
    #[Route(path: '/api/v1/connection/set-account-access', methods: ['POST'])]
