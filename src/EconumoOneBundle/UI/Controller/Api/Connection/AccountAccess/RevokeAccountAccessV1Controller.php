...
namespace App\EconumoOneBundle\UI\Controller\Api\Connection\AccountAccess;

use App\EconumoOneBundle\Application\Connection\AccountAccessService;
use App\EconumoOneBundle\Application\Connection\Dto\RevokeAccountAccessV1RequestDto;
use App\EconumoOneBundle\UI\Controller\Api\Connection\AccountAccess\Validation\RevokeAccountAccessV1Form;
...
class RevokeAccountAccessV1Controller extends AbstractController
{
     ...
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Connection\Dto\RevokeAccountAccessV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Connection\Dto\RevokeAccountAccessV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
     ...
     */
    #[Route(path: '/api/v1/connection/revoke-account-access', methods: ['POST'])]
