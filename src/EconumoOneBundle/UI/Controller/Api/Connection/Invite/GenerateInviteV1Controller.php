...
use App\EconumoOneBundle\UI\Controller\Api\Connection\Invite\Validation\GenerateInviteV1Form;
...
class GenerateInviteV1Controller extends AbstractController
{
     ...
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Connection\Dto\GenerateInviteV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Connection\Dto\GenerateInviteV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
