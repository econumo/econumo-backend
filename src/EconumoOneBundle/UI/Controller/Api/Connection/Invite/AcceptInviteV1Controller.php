...
use App\EconumoOneBundle\UI\Controller\Api\Connection\Invite\Validation\AcceptInviteV1Form;
...
class AcceptInviteV1Controller extends AbstractController
{
     ...
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\EconumoOneBundle\Application\Connection\Dto\AcceptInviteV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\EconumoOneBundle\Application\Connection\Dto\AcceptInviteV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
