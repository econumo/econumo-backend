...
SELECT gen_random_uuid(), tmp1.user_id, CASE WHEN COALESCE(transactions_balance, 0) + balance < 0 THEN 0 ELSE 1 END as type, tmp1.account_id, NULL, tmp1.missing_transaction, NULL, NULL, 'Econumo: Start balance', NULL, NULL, '1970-01-01 00:00:00', '1970-01-01 00:00:00', '1970-01-01 00:00:00'
