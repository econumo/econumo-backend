 ...
 */
final class Version20230220045503 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE budgets ADD CONSTRAINT FK_DCAA9548A76ED395 FOREIGN KEY (user_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE budget_access ADD CONSTRAINT FK_52DC6DE836ABA6B8 FOREIGN KEY (budget_id) REFERENCES budgets (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE budget_access ADD CONSTRAINT FK_52DC6DE8A76ED395 FOREIGN KEY (user_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE budget_categories ADD CONSTRAINT FK_ECF4892836ABA6B8 FOREIGN KEY (budget_id) REFERENCES budgets (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE budget_categories ADD CONSTRAINT FK_ECF4892812469DE2 FOREIGN KEY (category_id) REFERENCES categories (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE budget_tags ADD CONSTRAINT FK_1578967636ABA6B8 FOREIGN KEY (budget_id) REFERENCES budgets (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE budget_tags ADD CONSTRAINT FK_15789676BAD26311 FOREIGN KEY (tag_id) REFERENCES tags (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
