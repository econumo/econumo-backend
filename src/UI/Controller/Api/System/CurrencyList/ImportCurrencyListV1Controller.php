...
namespace App\UI\Controller\Api\System\CurrencyList;

use App\Application\System\CurrencyListService;
use App\Application\System\Dto\ImportCurrencyListV1RequestDto;
use App\UI\Controller\Api\System\CurrencyList\Validation\ImportCurrencyListV1Form;
...
class ImportCurrencyListV1Controller extends AbstractController implements SystemApiInterface
{
     ...
     *
     * @OA\Tag(name="System"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\Application\System\Dto\ImportCurrencyListV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\Application\System\Dto\ImportCurrencyListV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
