...
class DeleteTransactionV1Controller extends AbstractController
{
     ...
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\Application\Transaction\Dto\DeleteTransactionV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\Application\Transaction\Dto\DeleteTransactionV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
