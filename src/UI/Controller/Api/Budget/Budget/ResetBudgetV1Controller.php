...
use App\UI\Controller\Api\Budget\Budget\Validation\ResetBudgetV1Form;
...
class ResetBudgetV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\Application\Budget\Dto\ResetBudgetV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\Application\Budget\Dto\ResetBudgetV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
