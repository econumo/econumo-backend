...
use App\UI\Controller\Api\Budget\Budget\Validation\UpdateBudgetV1Form;
...
class UpdateBudgetV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\Application\Budget\Dto\UpdateBudgetV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\Application\Budget\Dto\UpdateBudgetV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
