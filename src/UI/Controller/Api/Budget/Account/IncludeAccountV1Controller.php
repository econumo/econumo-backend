...
use App\UI\Controller\Api\Budget\Account\Validation\IncludeAccountV1Form;
...
class IncludeAccountV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\Application\Budget\Dto\IncludeAccountV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\Application\Budget\Dto\IncludeAccountV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
