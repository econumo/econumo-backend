...
use App\UI\Controller\Api\Budget\Plan\Validation\UpdatePlanV1Form;
...
class UpdatePlanV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\Application\Budget\Dto\UpdatePlanV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\Application\Budget\Dto\UpdatePlanV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
     ...
     */
    #[Route(path: '/api/v1/budget/update-plan', methods: ['POST'])]
