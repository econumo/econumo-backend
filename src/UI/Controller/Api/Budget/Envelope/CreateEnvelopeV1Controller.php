...
namespace App\UI\Controller\Api\Budget\Envelope;

use App\Application\Budget\EnvelopeService;
use App\Application\Budget\Dto\CreateEnvelopeV1RequestDto;
use App\UI\Controller\Api\Budget\Envelope\Validation\CreateEnvelopeV1Form;
...
class CreateEnvelopeV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\Application\Budget\Dto\CreateEnvelopeV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\Application\Budget\Dto\CreateEnvelopeV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
     ...
     */
    #[Route(path: '/api/v1/budget/create-envelope', methods: ['POST'])]
