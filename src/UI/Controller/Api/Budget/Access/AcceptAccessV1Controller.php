...
use App\UI\Controller\Api\Budget\Access\Validation\AcceptAccessV1Form;
...
class AcceptAccessV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\Application\Budget\Dto\AcceptAccessV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\Application\Budget\Dto\AcceptAccessV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
