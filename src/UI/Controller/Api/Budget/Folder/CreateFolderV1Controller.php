...
use App\UI\Controller\Api\Budget\Folder\Validation\CreateFolderV1Form;
...
class CreateFolderV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Budget"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\Application\Budget\Dto\CreateFolderV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\Application\Budget\Dto\CreateFolderV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
