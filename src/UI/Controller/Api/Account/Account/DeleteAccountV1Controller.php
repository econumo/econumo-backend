...
class DeleteAccountV1Controller extends AbstractController
{
     ...
     *     in="body",
     *     required=true,
     *     @SWG\Schema(ref=@Model(type=\App\Application\Account\Account\Dto\DeleteAccountV1RequestDto::class)),
     * ),
     * @SWG\Response(
     *     response=200,
     *     description="OK",
     ...
     *                 @SWG\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\Application\Account\Account\Dto\DeleteAccountV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
