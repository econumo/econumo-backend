...
use App\UI\Controller\Api\Account\Account\Validation\DeleteAccountV1Form;
...
class DeleteAccountV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Account"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\Application\Account\Dto\DeleteAccountV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\Application\Account\Dto\DeleteAccountV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
