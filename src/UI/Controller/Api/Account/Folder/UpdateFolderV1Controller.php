...
use App\UI\Controller\Api\Account\Folder\Validation\UpdateFolderV1Form;
...
class UpdateFolderV1Controller extends AbstractController
{
     ...
     *
     * @OA\Tag(name="Account"),
     * @OA\RequestBody(@OA\JsonContent(ref=@Model(type=\App\Application\Account\Dto\UpdateFolderV1RequestDto::class))),
     * @OA\Response(
     *     response=200,
     *     description="OK",
     *     @OA\JsonContent(
     ...
     *                 @OA\Property(
     *                     property="data",
     *                     ref=@Model(type=\App\Application\Account\Dto\UpdateFolderV1ResultDto::class)
     *                 )
     *             )
     *         }
     *     )
